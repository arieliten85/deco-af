    ...
    <div className="grid grid-cols-1 lg:grid-cols-3">
      <div className="relative overflow-hidden py-10 px-6 bg-primary-gray sm:px-10 xl:p-12 rounded-t-2xl lg:rounded-l-2xl lg:rounded-tr-none   ">
        ...
        <p className="mt-6 text-base text-indigo-50 max-w-3xl">
          Estamos aquí para ayudarte a transformar tus espacios. Contáctanos
      ...
      <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12 bg-orange-500">
        <h3 className="text-lg font-medium text-white">Envíanos un mensaje</h3>
        <form className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
          ...
          <div className="sm:col-span-2">
            <Button
              type="submit"
              className="w-full bg-primary-gray text-white hover:bg-primary-gray-700"
            >
              Enviar mensaje
            </Button>
          </div>
